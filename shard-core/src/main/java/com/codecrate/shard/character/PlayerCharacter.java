 ...
 */
public class PlayerCharacter implements Comparable {
	private static final Log LOG = LogFactory.getLog(PlayerCharacter.class);
     ...
     */
    public PlayerCharacter(String name, AbilityScoreContainer abilities,
    		Race race,
    ...
    public boolean equals(Object object) {
        ...
        PlayerCharacter target = (PlayerCharacter) object;
