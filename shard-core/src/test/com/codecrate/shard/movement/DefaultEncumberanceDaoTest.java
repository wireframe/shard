...
public class DefaultEncumberanceDaoTest extends TestCase {
    ...
    public void testEffectiveWeightCalculatedUsingRacialSize() {
        ...
        EncumberanceDao dao = new DefaultEncumberanceDao();
        Encumberance encumberance = dao.getEncumberance(abilities, inventory, size);
        assertEquals(DefaultEncumberance.LIGHT, encumberance);
    }
}
