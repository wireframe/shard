...
public class AbilityScorePrerequisiteTest extends TestCase {
	...
	public void testPrereqMetWithHigherScore() {
		...
		mockAbilities.setReturnValue(new DefaultAbilityScore(DefaultAbility.STRENGTH, 5, null));
		...
		AbilityScorePrerequisite prereq = new AbilityScorePrerequisite(new DefaultAbilityScore(DefaultAbility.STRENGTH, 1, null));
	...
	public void testPrereqNotMetWithLowerScore() {
		...
		mockAbilities.setReturnValue(true);
		abilities.getAbilityScore(DefaultAbility.STRENGTH);
		mockAbilities.setReturnValue(new DefaultAbilityScore(DefaultAbility.STRENGTH, 0, null));
		mockAbilities.replay();
