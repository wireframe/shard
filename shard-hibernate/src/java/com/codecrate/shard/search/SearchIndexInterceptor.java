...
public class SearchIndexInterceptor implements Interceptor {
    private static final Log LOG = LogFactory.getLog(SearchIndexInterceptor.class);
    ...
    public boolean onSave(Object entity, Serializable id,
        ...
        try {
            ...
            document.add(Field.Keyword(HibernateSearcher.FIELD_CLASS, entity.getClass().getName()));
            document.add(Field.Keyword(HibernateSearcher.FIELD_ID, id.toString()));
            document.add(Field.Text(HibernateSearcher.FIELD_TEXT, entity.toString()));
